...
function Header() {
  return (
    <header className={`${cssClasses["product-page-header"]}}`}>
      ...
      >
        <div className={cssClasses["product-slider-con"]}>
          <ProductSlider />
        ...
        <div className={cssClasses["product-detiles-main-con"]}>
          <div className={cssClasses["product-detiles"]}>
            ...
            <div className={cssClasses["product-info-footer"]}>
              ...
              <div className={cssClasses["product-colors"]}>
                <p className={cssClasses["color-title"]}>
              ...
              <div className={cssClasses["product-additional-info"]}>
                <p>
                  <span>SKU</span>
                  <span>1117</span>
                </p>
